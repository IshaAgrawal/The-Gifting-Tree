...
function updateCart(realtimeapp) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', realtimeapp).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var realtimeapp = JSON.parse(btn.dataset.realtimeapp);
    updateCart(realtimeapp);
  });
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_myoNI3iy1Ne1vGyUZhShXUYd');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtime_app"] = self["webpackChunkrealtime_app"] || [];
